          ...
          <form onSubmit={handleSubmit(onSubmit)} className="pos-wrapper">
            ...
            <div className="wrapper">
              ...
              <div className="contenedor-apartados-formulario_usuario">
                            ...
                            <input class="solo-mostrar" ref={refPortada} type="file" name="portada" accept="image/*" onChange={(event) => cambiarFoto(event)}></input>
                        </div>

              <div className="form-group" id="nombre">
                <label htmlFor="nombre">Nombre:</label>
                <input class="solo-mostrar" type="text" id="nombre" name="nombre" defaultValue="Miriam" {...register('nombre', {
                  required: true,
                  maxLength: 20
                })} readOnly/>
              ...
              <div className="form-group" id="apellidos">
                ...
                <input class="solo-mostrar" type="text" id="apellidos" name="apellidos" defaultValue="García" {...register('apellidos', {
                  required: true,
                  maxLength: 50
                })} readOnly/>
              ...
              <div id="parte-inferior" >
                ...
                <div className="form-group" id="correo">
                  ...
                  <input class="solo-mostrar" type="email" id="correo" name="correo" defaultValue="miriam34@gmail.com" readOnly/>
                  <br /><br /></div>
                ...
                <div className="form-group" id="titulacion">
                  ...
                  <input  class="solo-mostrar" type="text" id="titulacion" name="titulacion" defaultValue="Arquitectura" readOnly/>
                  <br /><br />
                </div>

                <div className="form-group" id="titulacion">
                  <label for="estilo">Estilo:</label>
                  <input class="solo-mostrar" type="text" id="estilo" name="estilo" defaultValue="Letras grandes" readOnly/>
                  <br /><br />
                  </div>

                <div className="form-group" id="direccion">
                  <label for="direccion">Dirección:</label>
                  <input class="solo-mostrar" type="text" id="direccion" name="direccion" defaultValue="Calle Altozano, Alicante"   readOnly/>
                  <br /><br />
                </div>

                <div className="form-group" id="nacimiento">
                  <label for="fecha_nacimiento">Fecha de Nacimiento:</label>
                  <input  class="solo-mostrar" type="date" id="fecha_nacimiento" name="fecha_nacimiento" defaultValue="2023-05-24"
               readOnly />
