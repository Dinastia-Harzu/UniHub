           ...
           <section className="contenedor-datos">
               <article className="datos">
                   ...
                   <div className="ver-y-descargar-oculto">
                        <a href="https://www.omfgdogs.com/" target='blank'><FontAwesomeIcon icon={faDownload} size='xl' className='boton-descargar' /></a>
               ...
               <article className="resumen">
                   <p><b>Resumen:</b></p>
                   <p>Este trabajo consiste en la realización de un cortometraje que narra el día de un niño a través de
                       la caracterización de un avión de papel. Este comienza su día en el colegio y, al terminar las clases,
                       se va al parque a disfrutar de su entorno...</p>
               </article>
                   ...
                   <div>
                       ...
                       <div className="contenedor-comentario">
                           <p className="contenedor-usuario">
                               <img src="assets/Foto_Usuario.jpg" alt="foto-usuario" className='foto-usuario'></img>
                               <span><b>Carmina Lucía</b></span>
                           </p>
                           <p className='fecha-comentario'>Publicado en Marzo de 2024 </p>
                           <StarRating />
                           <p className='texto-comentario'>Creo que la autora ha creado una escena original y atractiva. El resultado es una obra de calidad,
                               con un buen nivel de detalle, realismo y expresividad. El trabajo también incluye una documentación
                               completa y rigurosa, donde se explica el proceso de creación, las referencias utilizadas, los problemas
                               encontrados y las soluciones adoptadas. Por todo ello, considero que el trabajo merece una calificación
                               excelente.</p>
                       </div>
                   </div>
               </article>
